...
<template>
  <footer class="w-full bg-black dark:bg-white rounded-t-[3rem] font-plus-jakarta">
    <div class="w-full px-4 sm:px-6 lg:px-8 py-24">
      <div class="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-16">
        <!-- Lado izquierdo - App Download y Copyright -->
        <div class="space-y-8">
          <div class="space-y-6">
            <h3 class="text-3xl font-bold text-white dark:text-black">
              Descargá<br>la app
            </h3>
            
            <!-- Botones de descarga -->
            <div class="flex flex-col sm:flex-row gap-4">
              <button class="flex items-center justify-center gap-3 px-8 py-4 border border-white dark:border-black rounded-lg bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-100 transition-all duration-200">
                <svg class="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                </svg>
                <span class="font-semibold text-lg">iOS</span>
              </button>
              ...
              <button class="flex items-center justify-center gap-3 px-8 py-4 border border-white dark:border-black rounded-lg bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-100 transition-all duration-200">
                ...
                <span class="font-semibold text-lg">Android</span>
              </button>
            </div>
          </div>
          ...
          <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="text-sm">
              <a href="#" class="text-gray-300 dark:text-gray-600 hover:text-white dark:hover:text-black transition-colors">
                Privacy Policy
              </a>
            </div>
          </div>
        ...
        <div class="space-y-8">
          <!-- Contacto -->
          <div class="space-y-3">
            <p class="text-white dark:text-black font-medium text-lg">
              Por consultas, devoluciones o situaciones técnicas:
            </p>
            <a href="mailto:nico.siciliano@hotmail.com" class="text-gray-300 dark:text-gray-600 hover:text-white dark:hover:text-black transition-colors text-lg">
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-5">
              <!-- Instagram -->
              <a href="#" class="w-12 h-12 border border-white dark:border-black rounded-lg flex items-center justify-center text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-100 transition-all duration-200">
